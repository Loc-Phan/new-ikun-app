...
// import {showLoading, saveDataWishlist} from 'app-redux/actions';

const PopularCoursesHorizontal = ({ item, onNavigateDetails }: any) => {
  ...
  return (
    <TouchableOpacity onPress={onNavigateDetail} style={styles.container}>
      ...
      <View
        ...
        <Image source={Images.iconDuration} style={{ width: 16, height: 16 }} />
...
PopularCoursesHorizontal.displayName = 'PopularCoursesHorizontal';

export default memo(PopularCoursesHorizontal);
